...
> **後續（同日傍晚）：本則描述的狀態已經結束。** §4 落地之後新欄位真的進 YAML 了，
> 下面「沒落地的部分」與「目前沒有生產者」那個窄理由都已退場。見
> `2026-08-24-identifiers-serialized.md`。本則保留原樣不改寫——它描述的是當時為真的
> 狀態，而把過期的紀錄改成看起來從未過期，正是本 repo 的規則在防的事。
