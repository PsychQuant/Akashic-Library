...
> |---|---|---|---|---|---|---|
> | 守衛支數與總時 | 11 支 59.4 秒 | 13 支 66.5 秒 | 15 支 77.1 秒 | 19 支 99.6 秒 | 20 支 149.3 秒 | **21 支 99.5 秒** |
> | 最大一支 | `marker-parity-mutations.py` 52.5 秒（88%） | 57.2 秒（86%） | 57.3 秒（74%） | 69.4 秒（70%） | 91.9 秒（62%） | **58.2 秒（58%）** |
> | 其餘 | 十支 7 秒 | 12 支 9.3 秒 | 14 支 19.8 秒 | 18 支 30.2 秒 | 19 支 57.4 秒 | **20 支 41.3 秒** |
