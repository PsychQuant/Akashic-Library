...
final class StdioE2ETests: XCTestCase {
    ...
    func testInitializeListCall() throws {
        ...
        XCTAssertEqual(tools.count, 28)   // #13/#14/#18/#77 歷次擴充；#76: + akashic_divergences；#68: + akashic_update_person；#290: + akashic_import_wos；#304: + venue×4 + org×2
...
extension StdioE2ETests {
    func testDeepNestingBombGetsErrorAndServerSurvives() throws {
        ...
        XCTAssertEqual(tools.count, 28, "深度炸彈之後 server 必須照常服務：\(listResp)")
