# split-record-reference Specification

## Purpose

TBD - created by archiving change 'split-verdict-historical-reference'. Update Purpose after archive.
...
<!-- @trace
source: split-verdict-historical-reference
updated: 2026-09-07
code:
  - README.md
  - Tests/AkashicKitTests/OrphanedSplitVerdictScanTests.swift
  - Sources/AkashicStoreIO/StoreHealth.swift
  - plugin/.claude-plugin/plugin.json
  - Sources/AkashicCore/Provenance.swift
  - Sources/AkashicCore/SplitRecordValue.swift
  ...
  - Tests/AkashicKitTests/SplitRecordReferenceTests.swift
  - Tests/AkashicMCPTests/SplitAuthorTests.swift
  - Sources/AkashicCore/Models.swift
  - mcpb/manifest.json
  - docs/store-format.md
  - Sources/AkashicMCPKit/AkashicService.swift
  - changelog/2026-09-07-split-verdict-historical-reference.md
  - Sources/akashic/Commands.swift
  - Tests/AkashicKitTests/Format13GateTests.swift
-->
