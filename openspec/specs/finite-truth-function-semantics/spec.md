# finite-truth-function-semantics Specification

## Purpose

TBD - created by archiving change 'complete-bounded-proposition-formula-semantics'. Update Purpose after archive.
