...
- 第 30 列的理由是**被守的記錄不退役**——第 18 列守的是一次遞進來的字串，這一列守的記錄只增不減，所以上限只擋得住單次呼叫，累積要另一盞燈（venue 側有第 16 列、person 與 organization 側缺，#645）
