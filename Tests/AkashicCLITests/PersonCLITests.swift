...
final class PersonCLITests: XCTestCase {
    ...
    func testEveryCLIServiceConstructionPassesRegistryKey() throws {
        ...
        XCTAssertEqual(constructions, 21,
                       ...
                       + "（venue／venues／add-venue／resolve-venues），共二十一處（#306 增 update-venue、#264 增 store-source、#386 增 resolve-people judge、#443 增 resolve-people attribute-org 與 split-author）；"
                       + "實際 \(constructions) 處——"
